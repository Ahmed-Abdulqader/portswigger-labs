...
First, I needed to find how many columns the original query returns. I used the `ORDER BY` technique (see [Lab 7: Determining Number of Columns](7.%20SQL%20injection%20UNION%20attack,%20determining%20the%20number%20of%20columns%20returned%20by%20the%20query.md)):
